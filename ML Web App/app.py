...
def severity():
    ...
    if z <0.25:
        ...
        severityReturn = [image_path, percentage_num, "Severity rating is 1 ", "Slight Infection"]
    elif z<0.50 and z >= 0.25:
        print("Severity rating is 2 ")
        print("Moderate Infection")

        severityReturn = [image_path, percentage_num, "Severity rating is 2 ", "Moderate Infection"]

    else:
        print("Severity rating is 3 ")
        print("Very Heavy Infection")
        severityReturn = [image_path, percentage_num, "Severity rating is 3 ", "Very Heavy Infection"]
